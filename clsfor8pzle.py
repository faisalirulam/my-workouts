...
class Node():
    def __init__(self,state,parent,action,depth,step_cost,path_cost,heuristic_cost):
        ...
        self.action=action                 #move-up,down,left,right
        self.depth=depth                   #depth 
        self.step_cost=step_cost           #cost to take the step   , g(n)
        self.path_cost=path_cost           #cost to reach current node  ,g(n)
        self.heuristic_cost=heuristic_cost   #cost to reach goal from current node  ,h(n)
    ...
    def print_path(self):
        ...
        while state_trace:
            ...
            ', step_cost=',str(step_cost_trace.pop()),', total_cost=',\
